...
rule recalibrate_base_qualities:
    input:
        ...
        known_2=config["ref"]["known-variants_2"],
        known_3=config["ref"]["known-variants_3"],
    output:
    ...
    threads: 24
    wrapper:
        "file:///scratch/03988/qscai/DNAs/wang/dna-seq-gatk-SNV-tumor_only/wrapper/baserecalibrator"
